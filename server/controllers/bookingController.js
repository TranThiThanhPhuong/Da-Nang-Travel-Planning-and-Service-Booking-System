...
export const createBooking = async (req, res, next) => {
    ...
    // 1. Kiểm tra toàn vẹn dữ liệu khách hàng gửi lên từ Form
    ...
    // Kiểm tra định dạng Regex cơ bản tại Server để tránh dữ liệu rác
    const emailRegex = /^\S+@\S+\.\S+$/;
    const phoneRegex = /^(0|84)(3|5|7|8|9)[0-9]{8}$/;

    if (!emailRegex.test(customerInfo.email)) {
        return res.status(400).json({ success: false, message: 'Định dạng địa chỉ Email không đúng.' });
    }
    ...
    try {
        ...
        // 2. Kiểm tra thông tin phân loại và biểu phí gốc của dịch vụ
        ...
        // 3. Định biên khoảng ngày lưu trữ dựa theo loại hình dịch vụ
        ...
        // 4. Thực thi nghiệp vụ kiểm tra trạng thái khả dụng kho
        ...
        // 5. Khởi tạo bản ghi đặt chỗ và đính kèm chi tiết biểu phí chiết khấu cùng thông tin khách động
