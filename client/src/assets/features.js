export const FEATURES_CONFIG = {
    ...
    RESTAURANT: [
...

      {
        title: "Phù hợp cho",
        items: [
          { value: "GOOD_FOR_GROUPS", label: "Nhóm đông" },
          { value: "COUPLE", label: "Cặp đôi" },
          { value: "FAMILY", label: "Gia đình" },
          { value: "INSTAGRAMMABLE", label: "Check-in đẹp" },
...

      {
        ...
        items: [
          ...
          { value: "LATE_NIGHT", label: "Mở khuya" },
    ...
    ACTIVITY: [
...

      {
        ...
        items: [
          ...
          { value: "GROUP_FRIENDS", label: "Nhóm bạn" },
          { value: "SOLO_TRAVELER", label: "Du lịch một mình" },
          { value: "THRILL_SEEKER", label: "Ưa mạo hiểm" },
        ],
      },
    ],
  };